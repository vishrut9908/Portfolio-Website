...
const Project = () => {
  return (
    <>
              ...
              <div className='flex flex-col overflow-auto  space-y-3 my-3 mx-1 w-full md:w-5/12 '>
                ...
                <div className='w-auto flex space-x-5 relative'>
                  ...
                  <a href={project.link} target='_blank' rel='noreferrer'>
                    {project.link && <img src='./images/icons/external-link.svg' alt='link to live website' width='24px' height='24px' />}
                  </a>
                </div>
              </div>
            </article>
      ...
      <div className='mx-5'>
        <a href='https://github.com/vishrut9908' target='_blank' rel='noreferrer' className='bg-gray block shadow-lg uppercase border border-gray-500 rounded-lg text-center my-12 p-2 max-w-xs m-auto'>
